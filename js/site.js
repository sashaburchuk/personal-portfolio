...
// Get width of all work list items and calculate and set width
function setContainerWidth() {
  listItems = document.querySelectorAll('.js-recent-work-item');
  ...
  container = document.querySelector('.js-scrollable-container');
